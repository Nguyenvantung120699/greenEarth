															...
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																		<table width="100%" border="0" cellspacing="0" cellpadding="0">
																			<tr>
																				<td class="h2 pb20" style="color:#050505; font-family:'Roboto', Arial,sans-serif; font-size:28px; line-height:34px; text-align:left; padding-bottom:20px;"><multiline>Green Earth Introduction</multiline></td>
																			</tr>
																			<tr>
																				<td class="text pb20" style="color:#666666; font-family:'Roboto', Arial,sans-serif; font-size:16px; line-height:28px; text-align:left; padding-bottom:20px;"><multiline><h4>Cảm ơn bạn đã đăng kí phỏng vấn công việc Green Earth</h4> 
																				<b>thông tin đăng kí : </b>
																				<p>name : {{$introduction->name}}</p>
																				<p>email : {{$introduction->email}}</p>
																				<p>gender : {{$introduction->gender}}</p>
																				<p>telephone : {{$introduction->telephone}}</p>
																				<p>address : {{$introduction->address}}</p>
																				<p>message : {{$introduction->message}}</p></br>
																				<p>vui lòng chờ email thông báo lịch phỏng vấn ! Thank</p>
																				</multiline></td>                                                    
																			</tr>
																			<!-- Button -->
																			<tr>
